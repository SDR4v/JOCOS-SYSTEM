...
// 5 days/year total, split into two non-fungible semester buckets: 2 for
// Jan-Jun, 3 for Jul-Dec. A single request may cover at most 3 consecutive days.

export type Semester = 1 | 2;

export const SEMESTER_ALLOTMENT: Record<Semester, number> = { 1: 2, 2: 3 };
