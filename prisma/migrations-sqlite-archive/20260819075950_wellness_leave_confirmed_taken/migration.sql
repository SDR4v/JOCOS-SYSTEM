...
INSERT INTO "new_WellnessLeaveRequest" ("cancelledAt", "cancelledById", "createdAt", "daysCount", "employeeId", "endDate", "id", "notes", "requestedById", "startDate", "status") SELECT "cancelledAt", "cancelledById", "createdAt", "daysCount", "employeeId", "endDate", "id", "notes", "requestedById", "startDate", "status" FROM "WellnessLeaveRequest";
