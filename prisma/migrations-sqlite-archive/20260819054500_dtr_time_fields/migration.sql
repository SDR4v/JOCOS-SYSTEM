...
INSERT INTO "new_AttendanceDay" ("code", "createdAt", "date", "dayCredit", "editedAt", "editedById", "employeeId", "id", "lateMinutes", "notes", "source") SELECT "code", "createdAt", "date", "dayCredit", "editedAt", "editedById", "employeeId", "id", "lateMinutes", "notes", "source" FROM "AttendanceDay";
...
INSERT INTO "new_DtrEntryRequest" ("date", "employeeId", "id", "notes", "reviewedAt", "reviewedById", "status", "submittedAt") SELECT "date", "employeeId", "id", "notes", "reviewedAt", "reviewedById", "status", "submittedAt" FROM "DtrEntryRequest";
