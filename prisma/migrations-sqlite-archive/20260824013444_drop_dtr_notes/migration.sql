/*
  ...
  - You are about to drop the column `notes` on the `AttendanceDay` table. All the data in the column will be lost.
  - You are about to drop the column `notes` on the `DtrEntryRequest` table. All the data in the column will be lost.
